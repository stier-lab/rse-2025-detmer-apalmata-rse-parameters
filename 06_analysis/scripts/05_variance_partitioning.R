...
#
# OUTPUTS:
#   - 06_analysis/output/size_space_time_survival.csv
#   - 06_analysis/output/size_space_time_growth.csv
#   - 06_analysis/output/variance_partitioning.csv
#   - 06_analysis/figures/supplementary/exploratory/size_space_time_panels.png
#   - 06_analysis/figures/supplementary/exploratory/size_region_heatmap.png
#
