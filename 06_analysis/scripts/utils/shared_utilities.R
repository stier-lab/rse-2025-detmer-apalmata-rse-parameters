...
# that call source("06_analysis/scripts/utils/shared_utilities.R") continue to
# work unchanged.
#
# Module load order:
...
.utils_dir <- if (file.exists("06_analysis/scripts/utils/00_libraries.R")) {
  "06_analysis/scripts/utils"
} else if (file.exists("analysis/scripts/utils/00_libraries.R")) {
  ...
  stop("Cannot find utils directory. Run from project root or 06_analysis/scripts/")
}
