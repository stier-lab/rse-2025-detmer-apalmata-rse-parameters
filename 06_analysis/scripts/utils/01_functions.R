...
canonical_artifact_registry <- function(project_root = NULL) {
  ...
  data.frame(
    ...
    artifact = c(
      ...
      "FigS20_annual_survival_timeseries",
      "FigS21_forest_plots",
      "FigS22_heatwave_scenarios",
      "FigS23_disturbance_timeline",
      "FigS24_heat_stress_survival",
      "FigS25_disturbance_sensitivity",
      "FigS26_natural_vs_restoration_comparison",
      "FigS28_temporal_synthesis",
    ...
    path = c(
      ...
      "06_analysis/figures/supplementary/FigS20_annual_survival_timeseries.png",
      "06_analysis/figures/supplementary/FigS21_forest_plots.png",
      "06_analysis/figures/supplementary/FigS22_heatwave_scenarios.png",
      "06_analysis/figures/supplementary/FigS23_disturbance_timeline.png",
      ...
      "06_analysis/figures/supplementary/FigS29_biological_realism.png",
