...
| Category | Count |
|----------|-------|
| Studies included in meta-analysis (survival) | 18 publications (k=18 study-level effects) |
...
| Neely et al. 2022 | Neely, K.L. et al. (2022). | 608 *A. palmata* colonies at 9 Florida Keys sites | NOAA_survey (probable) | Geographic overlap with NOAA monitoring sites. Excluded pending verification of colony-level independence (raw data needed from authors). |
| Sutherland et al. 2016 (FKNMS component) | Sutherland, K.P. et al. (2016). *PLoS Pathog* 12:e1005904. | FKNMS contemporary monitoring (2008--2014), Carysfort and Molasses reefs | NOAA_survey | Spatial overlap at Carysfort and Molasses reefs with NOAA monitoring. Only the EDR historical dataset (1994--2004) from this paper is included; the FKNMS component is excluded. |
...
| **Total** | | **18 publications, k=18 study-level effects** | **~6,616** |
