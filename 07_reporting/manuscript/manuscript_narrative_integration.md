...
- Frame the biological problem as a question of how size, disturbance, and restoration history jointly shape demographic performance, rather than as a single pooled estimate problem (`07_reporting/internal/paper_scope_and_analysis_roadmap.md`).
...
- Make disturbance explicit as Caribbean demographic regime structure: hurricanes, disease, heatwaves, and chronic pressures change the performance landscape, they do not simply add noise (`07_reporting/internal/transferability_summary.md`, `06_analysis/output/study_window_disturbance_summary_overall.csv`).
