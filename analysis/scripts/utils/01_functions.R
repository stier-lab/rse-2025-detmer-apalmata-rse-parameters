...
setup_output_dirs <- function(project_root = NULL) {
  ...
  dirs <- list(
    ...
    figures_manuscript  = file.path(project_root, "analysis/figures/manuscript"),
    figures_supp        = file.path(project_root, "analysis/figures/supplementary"),
    figures_exp         = file.path(project_root, "analysis/figures/supplementary/exploratory")
  )
...
save_manuscript_fig <- function(plot, filename, width_mm = 170, height_mm = 120,
                                fig_dir = NULL) {
  if (is.null(fig_dir)) {
    fig_dir <- file.path(get_project_root(), "analysis/figures/manuscript")
  }
