...
#   - analysis/output/growth_random_effects.csv
#   - analysis/figures/supplementary/exploratory/growth_threshold_detection.png
#   - analysis/figures/supplementary/exploratory/positive_growth_probability.png
#   - analysis/figures/supplementary/diagnostics/growth_model_diagnostics.png
#
