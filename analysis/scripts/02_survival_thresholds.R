...
#   - analysis/output/survival_random_effects.csv
#   - analysis/figures/supplementary/exploratory/survival_threshold_detection.png
#   - analysis/figures/supplementary/diagnostics/survival_model_diagnostics.png
#
