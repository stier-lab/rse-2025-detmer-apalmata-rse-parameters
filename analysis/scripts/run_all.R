...
#   - All figures in analysis/figures/manuscript/ (PNG + PDF)
...
for (i in seq_along(scripts)) {
  script_path <- file.path("analysis/scripts", scripts[i])
...
output_checks <- list(
  ...
  "Gap analysis" = c(
    "analysis/output/gap_prioritization.csv",
    "analysis/output/certainty_by_size_region.csv"
  ),
  "Transition matrix" = c(
    "analysis/output/transition_matrix.csv",
    "analysis/output/population_parameters.csv"
  ),
  "Meta-analysis" = c(
    "analysis/output/meta_analysis_results.csv",
    "analysis/output/expanded_meta_analysis_results.csv"
  ),
  "Manuscript figures" = c(
    "analysis/figures/manuscript/Fig1_study_landscape.png",
    "analysis/figures/manuscript/Fig2_demographic_rates.png",
    "analysis/figures/manuscript/Fig3_natural_vs_restoration.png",
    "analysis/figures/manuscript/Fig4_size_class_survival.png",
    "analysis/figures/manuscript/Fig5_expanded_forest_plot.png",
    "analysis/figures/manuscript/Fig6_population_model.png"
  ),
  "Supplementary figures" = c(
    "analysis/figures/supplementary/FigS1_size_distribution.png",
    "analysis/figures/supplementary/FigS2_data_gaps.png",
    "analysis/figures/supplementary/FigS3_model_diagnostics.png",
    "analysis/figures/supplementary/FigS5_threshold_analysis.png",
    "analysis/figures/supplementary/FigS8_forest_plots.png",
    "analysis/figures/supplementary/FigS10_context_comparison.png",
    "analysis/figures/supplementary/FigS12_sensitivity.png",
    "analysis/figures/supplementary/FigS15_regional_survival.png"
  )
)
...
log_file <- sprintf("analysis/output/pipeline_log_%s.csv",
