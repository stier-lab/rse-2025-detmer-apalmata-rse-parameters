...
#
# OUTPUTS:
#   - analysis/output/survival_by_study_combined.csv
#   - analysis/output/growth_by_study_combined.csv
#   - analysis/output/regional_estimates_combined.csv
#   - analysis/output/summary_data_contribution.csv
#   - analysis/output/fragment_survival_summary.csv
#   - analysis/output/data_source_overlap.csv
#   - analysis/output/size_class_reliability.csv
#
