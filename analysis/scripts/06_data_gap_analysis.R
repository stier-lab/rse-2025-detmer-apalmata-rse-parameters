...
#
# OUTPUTS:
#   - analysis/output/certainty_by_size_class.csv
#   - analysis/output/certainty_by_region.csv
#   - analysis/output/data_gaps_identified.csv
#   - analysis/output/gap_prioritization.csv
#   - analysis/output/recommended_studies.csv
#   - analysis/output/certainty_matrix.csv
#   - analysis/output/temporal_coverage_by_region.csv
#   - analysis/output/gap_summary_counts.csv
#   - analysis/figures/supplementary/exploratory/certainty_heatmap.png
#   - analysis/figures/supplementary/exploratory/gap_prioritization.png
#
