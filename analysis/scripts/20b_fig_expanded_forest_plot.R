...
#
# INPUT:
#   analysis/output/expanded_meta_analysis_study_effects.csv  (16 rows)
#   analysis/output/expanded_meta_analysis_results.csv        (pooled stats)
#   analysis/output/expanded_meta_analysis_stratified.csv     (subgroup pooled)
#
# OUTPUT:
#   analysis/figures/manuscript/Fig3_caribbean_synthesis.{png,pdf}
#
