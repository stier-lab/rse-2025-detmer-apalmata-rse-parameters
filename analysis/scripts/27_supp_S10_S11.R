...
#
# INPUTS:
#   - analysis/output/context_survival_comparison.csv
#   - analysis/output/context_survival_by_size.csv
#   - analysis/output/context_pairwise_survival.csv
#   - analysis/output/yearly_survival.csv
#   - analysis/output/temporal_trend_glmm.csv
#   - analysis/output/disturbance_impacts.csv
#   - analysis/output/size_climate_vulnerability.csv
#   - analysis/output/regional_temporal_variability.csv
#
# OUTPUTS:
#   - analysis/figures/supplementary/FigS10_context_comparison.png  (+ .pdf)
#   - analysis/figures/supplementary/FigS11_climate_demography.png  (+ .pdf)
#
