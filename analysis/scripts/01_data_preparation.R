...
#
# INPUTS:
#   - standardized_data/apal_surv_ind.csv (individual survival data)
#   - standardized_data/apal_growth_ind.csv (individual growth data)
#   - standardized_data/apal_surv_summ.csv (summarized survival data)
#
# OUTPUTS:
#   - analysis/output/prepared_survival_data.rds
#   - analysis/output/prepared_growth_data.rds
#   - analysis/output/summary_survival_by_size.csv
#   - analysis/output/summary_growth_by_size.csv
#   - analysis/output/summary_survival_by_region.csv
#   - analysis/output/summary_growth_by_region.csv
#   - analysis/output/summary_survival_by_datatype.csv
#   - analysis/output/summary_temporal_coverage.csv
#   - analysis/output/data_filtering_audit.csv
#   - analysis/output/size_class_distribution.csv
#   - analysis/output/impossible_growth_summary.csv
#   - analysis/output/observation_intervals.csv
#   - analysis/output/study_metadata.csv
#
...
data_dir <- file.path(project_root, "standardized_data")
