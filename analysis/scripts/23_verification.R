...
if (file.exists(growth_summary_file)) {
  ...
  cat("Source: analysis/output/growth_rate_summary.csv\n\n")
...
if (file.exists(meta_file)) {
  ...
  cat("Source: analysis/output/meta_analysis_results.csv\n\n")
...
if (file.exists(threshold_file)) {
  ...
  cat("Source: analysis/output/survival_thresholds.csv\n\n")
...
cat("See analysis/figures/DATA_INTEGRATION_REPORT.md for full audit details.\n\n")
