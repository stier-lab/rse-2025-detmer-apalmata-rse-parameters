...
#
# OUTPUTS:
#   - analysis/output/climate_survival_effects.csv
#   - analysis/output/disturbance_impacts.csv
#   - analysis/figures/supplementary/exploratory/climate_demography.png
#
...
fig_dir <- file.path(project_root, "analysis/figures/supplementary/exploratory")
...
dhw_file <- file.path(project_root, "original_data", "noaa_dhw_caribbean.csv")
...
if (file.exists(dhw_file)) {
  ...
  cat("    3. Save to: original_data/noaa_dhw_caribbean.csv\n")
}
