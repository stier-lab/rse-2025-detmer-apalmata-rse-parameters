...
#
# INPUTS:
#   - analysis/output/sensitivity_lambda_loo.csv
#   - analysis/output/sensitivity_lambda_boundaries.csv
#   - analysis/output/sensitivity_lambda_outliers.csv
#   - analysis/output/bootstrap_confidence_intervals.csv
#   - analysis/output/cross_validation_results.csv
#   - analysis/output/cv_model_comparison.csv
#   - analysis/output/transition_matrix.rds
#   - analysis/output/stochastic_projections.csv
#   - analysis/output/population_parameters.csv
#
# OUTPUTS:
#   - analysis/figures/supplementary/FigS12_sensitivity.png + .pdf
#   - analysis/figures/supplementary/FigS13_cross_validation.png + .pdf
#   - analysis/figures/supplementary/FigS14_population_projections.png + .pdf
#
...
cat("  All saved to: analysis/figures/supplementary/\n")
cat("================================================================\n")
