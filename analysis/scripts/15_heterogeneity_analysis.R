...
#
# OUTPUTS:
#   - analysis/output/heterogeneity_analysis.csv
#   - analysis/output/study_effect_sizes.csv
#   - analysis/output/moderator_effects.csv
#   - analysis/figures/supplementary/exploratory/heterogeneity_forest_plot.png
#
